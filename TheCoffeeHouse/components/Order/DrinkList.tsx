...
const drinks = [
  {
    topic: 'Món mới phải thử',
    data: [
      {
        image:
          'https://product.hstatic.net/1000075078/product/1669736877_tra-sua-oolong-nuong-tran-chau_a8be7cbc82464553bd82e6236c31c937_large.png',
        name: 'Trà sữa Oolong Nướng Trân Châu',
        price: '50.000đ',
      },
      {
        image:
          'https://product.hstatic.net/1000075078/product/bottle_oolong_285082_02545c46c6284dcdb739ec9221154c3e_large.jpg',
  ...
  return (
    <View style={styles.container}>
      {drinks.map((item, index) => (
        <View style={styles.typeOfDrink} key={index}>
